...
#     g.addEdge("V8", "V9", "E14", 7);
    ...
    g.addEdge("V1", "V8", "E2", 6);

    g.addEdge("V2", "V3", "E3", 6);
    g.addEdge("V2", "V8", "E4", 6);

    g.addEdge("V3", "V4", "E5", 6);
    g.addEdge("V3", "V6", "E6", 6);
    g.addEdge("V3", "V9", "E7", 6);

    g.addEdge("V4", "V5", "E8", 6);
    g.addEdge("V4", "V6", "E9", 6);
    
    g.addEdge("V5", "V6", "E10", 6);

    g.addEdge("V6", "V7", "E11", 6);

    g.addEdge("V7", "V8", "E12", 6);
    g.addEdge("V7", "V9", "E13", 6);
    
    g.addEdge("V8", "V9", "E14", 6);
...
#     g1.addEdge("V1", "V4", 10);
    ...
    g.addEdge("V1", "V2", "E1", 6);
    g.addEdge("V1", "V7", "E2", 6);
    
    g.addEdge("V2", "V3", "E3", 6);
    g.addEdge("V2", "V7", "E4", 6);
    g.addEdge("V2", "V8", "E5", 6);
    
    g.addEdge("V3", "V4", "E6", 6);
    g.addEdge("V3", "V6", "E7", 6);
    g.addEdge("V3", "V7", "E8", 6);
    g.addEdge("V3", "V8", "E9", 6);
    
    g.addEdge("V4", "V5", "E10", 6);
    g.addEdge("V4", "V8", "E11", 6);
    
    g.addEdge("V5", "V6", "E12", 6);
    
    g.addEdge("V6", "V7", "E13", 6);
    
    sp = ShortestPath();
    sp.singleSourceShortedPathUsingDijsktraAlgo(g, "UNDIRECTED", "V1");